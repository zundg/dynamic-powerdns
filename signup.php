...
mysql_query("insert into records (domain_id, name, type, content, ttl) values ($domain_id, '$host.$domain', 'NS', '$ns1', 3600)");
mysql_query("insert into records (domain_id, name, type, content, ttl) values ($domain_id, '$host.$domain', 'NS', '$ns2', 3600)");
